...
Immediate block: native-02 verified four corrected Continues, weapon lighting and service/exit headers. Export the full flow; operate FPS preference/injury feedback and measure uncaptured performance. Then obtain actual first exploration/pacing/listening checks. The known fast diagnostic path is much shorter than the duration target; do not add waiting or count pauses as game time.
