...
1. Separate adversarial reviews use retained workers after new-worker creation was refused: core_m2 reviews M0 in agent/review-toolchain; bootstrap_m0 reviews native harness in agent/review-native. Neither reviews its own feature. Native initial FAIL712cefe plus later inspector evidence awaits corrected source. Inspect exact sources/evidence, reproduce and open full-resolution captures. No self-grading or product/auditory scores.
