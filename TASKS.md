...
1. Separate adversarial M0/native-QA reviewer: inspect exact committed sources and evidence, rerun installer offline/import/exports and a fresh controlled native proof, test ownership/cleanup/failure behavior, open full-resolution captures. Separate verdict for each scope; no product or auditory scores.
